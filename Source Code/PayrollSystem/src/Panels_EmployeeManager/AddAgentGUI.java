...
public final class AddAgentGUI extends javax.swing.JDialog {
    Connection conn;
    ResultSet rs=null;
     ...
     */
    public AddAgentGUI() throws SQLException, IOException {
        initComponents();
    ...
    private void stepexitBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_stepexitBTNActionPerformed
        try {
            ...
            Logger.getLogger(AddAgentGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new AddAgentGUI().setVisible(true);
